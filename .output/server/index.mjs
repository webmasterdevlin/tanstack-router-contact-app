...
import { defaultTransformer, isRedirect as isRedirect$1, isNotFound, createRootRoute, Outlet, ScrollRestoration, createFileRoute, lazyRouteComponent, lazyFn, createMemoryHistory, useRouter, useRouterState, isPlainArray, isPlainObject as isPlainObject$1, RouterProvider, ScriptOnce, createRouter as createRouter$2, defer as defer$1, pick, TSR_DEFERRED_PROMISE, createControlledPromise } from '@tanstack/react-router';
import { AsyncLocalStorage } from 'node:async_hooks';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import * as D$3 from 'react';
import { createElement, createContext as createContext$1 } from 'react';
import B$2 from 'react-dom/server';
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app","order":0,"outDir":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app","outDir":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app","base":"/","outDir":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/.pnpm/@tanstack+start@1.87.12_@types+node@22.10.2_ioredis@5.4.1_jiti@2.4.1_react-dom@18.3.1_react@1_5pyu6a7c772hasghxle2sxgbxi/node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app","outDir":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/.vinxi/build/server","order":3},{"name":"api","base":"/api","type":"http","handler":"app/api.ts","target":"server","root":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app","outDir":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/.vinxi/build/api","order":4}],"server":{"preset":"bun","experimental":{"asyncContext":true}},"root":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app"};
				const buildManifest = {"client":{"_client-BbH3N5Po.js":{"file":"assets/client-BbH3N5Po.js","name":"client","dynamicImports":["app/routes/about.tsx?tsr-split","app/routes/index.tsx?tsr-split","app/routes/profile/settings.tsx?tsr-split","app/routes/contacts.$contactId.index.tsx?tsr-split","app/routes/contacts.$contactId.index.tsx?tsr-split","app/routes/contacts.$contactId.edit.tsx?tsr-split","app/routes/contacts.$contactId.edit.tsx?tsr-split"]},"_contacts-afs_pgEK.js":{"file":"assets/contacts-afs_pgEK.js","name":"contacts","imports":["_client-BbH3N5Po.js"]},"app/routes/about.tsx?tsr-split":{"file":"assets/about-BJ-2WOTg.js","name":"about","src":"app/routes/about.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-BbH3N5Po.js"]},"app/routes/contacts.$contactId.edit.tsx?tsr-split":{"file":"assets/contacts._contactId.edit-Vw9S2yai.js","name":"contacts._contactId.edit","src":"app/routes/contacts.$contactId.edit.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-BbH3N5Po.js","_contacts-afs_pgEK.js"]},"app/routes/contacts.$contactId.index.tsx?tsr-split":{"file":"assets/contacts._contactId.index-Co7gbx2P.js","name":"contacts._contactId.index","src":"app/routes/contacts.$contactId.index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-BbH3N5Po.js","_contacts-afs_pgEK.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-CCvct0mt.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-BbH3N5Po.js"]},"app/routes/profile/settings.tsx?tsr-split":{"file":"assets/settings-BK4whTGZ.js","name":"settings","src":"app/routes/profile/settings.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-BbH3N5Po.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-BszfEbDQ.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-BbH3N5Po.js"]}},"ssr":{"_contacts-DoWpUKty.js":{"file":"assets/contacts-DoWpUKty.js","name":"contacts"},"_ssr-BPHchSOx.js":{"file":"assets/ssr-BPHchSOx.js","name":"ssr","dynamicImports":["app/routes/about.tsx?tsr-split","app/routes/index.tsx?tsr-split","app/routes/profile/settings.tsx?tsr-split","app/routes/contacts.$contactId.index.tsx?tsr-split","app/routes/contacts.$contactId.index.tsx?tsr-split","app/routes/contacts.$contactId.edit.tsx?tsr-split","app/routes/contacts.$contactId.edit.tsx?tsr-split"]},"app/routes/about.tsx?tsr-split":{"file":"assets/about-CpGDTWru.js","name":"about","src":"app/routes/about.tsx?tsr-split","isDynamicEntry":true},"app/routes/contacts.$contactId.edit.tsx?tsr-split":{"file":"assets/contacts._contactId.edit-02zvbxDx.js","name":"contacts._contactId.edit","src":"app/routes/contacts.$contactId.edit.tsx?tsr-split","isDynamicEntry":true,"imports":["_contacts-DoWpUKty.js","_ssr-BPHchSOx.js"]},"app/routes/contacts.$contactId.index.tsx?tsr-split":{"file":"assets/contacts._contactId.index-BMreN9tO.js","name":"contacts._contactId.index","src":"app/routes/contacts.$contactId.index.tsx?tsr-split","isDynamicEntry":true,"imports":["_contacts-DoWpUKty.js","_ssr-BPHchSOx.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-hzFDNqBm.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true},"app/routes/profile/settings.tsx?tsr-split":{"file":"assets/settings-Jpq5jLzu.js","name":"settings","src":"app/routes/profile/settings.tsx?tsr-split","isDynamicEntry":true},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-BPHchSOx.js"]}},"server":{"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}},"api":{"virtual:$vinxi/handler/api":{"file":"api.js","name":"api","src":"virtual:$vinxi/handler/api","isEntry":true}}};
...
const assets$1 = {
  "/_build/server-functions-manifest.json": {
    ...
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 25,
    "path": "../public/_build/server-functions-manifest.json"
  },
  "/_build/.vite/manifest.json": {
    "type": "application/json",
    "etag": "\"8ce-rre1QuIRUgBq+T4ZgQ7bK1EYByg\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 2254,
    "path": "../public/_build/.vite/manifest.json"
  },
  "/_build/assets/about-BJ-2WOTg.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"86-ZgpdM9wVCW+4w2o3aJKsYNQrbVo\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 134,
    "path": "../public/_build/assets/about-BJ-2WOTg.js"
  },
  "/_build/assets/client-BbH3N5Po.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"41e8f-LI/+gn6C32uBAJEpxVmHxuhVo60\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 269967,
    "path": "../public/_build/assets/client-BbH3N5Po.js"
  },
  "/_build/assets/client-BszfEbDQ.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3f-4VYmweDRrgZypgzTK4oL12FdJP0\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 63,
    "path": "../public/_build/assets/client-BszfEbDQ.js"
  },
  "/_build/assets/contacts-afs_pgEK.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"7712-H+tdwIw1Y653jbbnhqqBEVslZr0\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 30482,
    "path": "../public/_build/assets/contacts-afs_pgEK.js"
  },
  "/_build/assets/contacts._contactId.edit-Vw9S2yai.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"5d3-B9hY+rcxLBPv7yOAen4oB7zkrC8\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 1491,
    "path": "../public/_build/assets/contacts._contactId.edit-Vw9S2yai.js"
  },
  "/_build/assets/contacts._contactId.index-Co7gbx2P.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"65e-6uq9X+r6es/75eLbozPTGUQShp4\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 1630,
    "path": "../public/_build/assets/contacts._contactId.index-Co7gbx2P.js"
  },
  "/_build/assets/index-CCvct0mt.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"129-i97jseoPMTnZ0KB0jxENgoXiDqc\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 297,
    "path": "../public/_build/assets/index-CCvct0mt.js"
  },
  "/_build/assets/settings-BK4whTGZ.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"91-HJt5kOS0ZS0fAsOJIxSZNs4uMvU\"",
    "mtime": "2024-12-13T03:54:13.673Z",
    "size": 145,
    "path": "../public/_build/assets/settings-BK4whTGZ.js"
  }
};
...
const _RJqYXm = eventHandler((event) => {
...
var I$2="Invariant failed";function _$1(e,t){if(!e)throw new Error(I$2)}function O$1(e={}){let t,r=!1;const s=n=>{if(t&&t!==n)throw new Error("Context conflict")};let a;if(e.asyncContext){const n=e.AsyncLocalStorage||globalThis.AsyncLocalStorage;n?a=new n:console.warn("[unctx] `AsyncLocalStorage` is not provided.");}const l=()=>{if(a&&t===void 0){const n=a.getStore();if(n!==void 0)return n}return t};return {use:()=>{const n=l();if(n===void 0)throw new Error("Context is not available");return n},tryUse:()=>l(),set:(n,o)=>{o||s(n),t=n,r=!0;},unset:()=>{t=void 0,r=!1;},call:(n,o)=>{s(n),t=n;try{return a?a.run(n,o):o()}finally{r||(t=void 0);}},async callAsync(n,o){t=n;const f=()=>{t=n;},d=()=>t===n?f:void 0;x.add(d);try{const u=a?a.run(n,o):o();return r||(t=void 0),await u}finally{x.delete(d);}}}}function P$2(e={}){const t={};return {get(r,s={}){return t[r]||(t[r]=O$1({...e,...s})),t[r]}}}const p=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof global<"u"?global:{},S$1="__unctx__",U$1=p[S$1]||(p[S$1]=P$2()),W$2=(e,t={})=>U$1.get(e,t),b$1="__unctx_async_handlers__",x=p[b$1]||(p[b$1]=new Set);function j(e){let t;const r=C$1(e),s={duplex:"half",method:e.method,headers:e.headers};return e.node.req.body instanceof ArrayBuffer?new Request(r,{...s,body:e.node.req.body}):new Request(r,{...s,get body(){return t||(t=K(e),t)}})}function J(e){return e.web??={request:j(e),url:C$1(e)},e.web.request}function $$1(){return E$1()}const T=Symbol("$HTTPEvent");function M$1(e){return typeof e=="object"&&(e instanceof H3Event||e?.[T]instanceof H3Event||e?.__is_event__===!0)}function h$1(e){return function(...t){let r=t[0];if(M$1(r))t[0]=r instanceof H3Event||r.__is_event__?r:r[T];else {if(!globalThis.app.config.server.experimental?.asyncContext)throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");if(r=$$1(),!r)throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");t.unshift(r);}return e(...t)}}const C$1=h$1(getRequestURL),D$1=h$1(getResponseStatus),K=h$1(getRequestWebStream);function B$1(){return W$2("nitro-app",{asyncContext:!!globalThis.app.config.server.experimental?.asyncContext,AsyncLocalStorage:AsyncLocalStorage})}function E$1(){return B$1().use().event}function G(e){return globalThis.MANIFEST[e]}const Z$1=eventHandler(z);async function z(e){return Q$1(J(e))}async function Q$1(e,t){var r,s;const a=e.method,l=new URL(e.url,"http://localhost:3000"),n=Object.fromEntries(l.searchParams.entries()),o=n._serverFnId,f=n._serverFnName;if(!o||!f)throw new Error("Invalid request");_$1(typeof o=="string");const d=(s=await((r=G("server").chunks[o])==null?void 0:r.import()))==null?void 0:s[f],u=await(async()=>{try{const i=await(async()=>{var v;if((v=e.headers.get("Content-Type"))!=null&&v.includes("multipart/form-data"))return _$1(a.toLowerCase()!=="get","GET requests with FormData payloads are not supported"),await e.formData();if(a.toLowerCase()==="get")return n.payload?defaultTransformer.parse(n.payload):void 0;const A=await e.text();return defaultTransformer.parse(A)})(),c=await d(i);return c instanceof Response?c:isRedirect$1(c)||isNotFound(c)?R$1(c):new Response(c!==void 0?defaultTransformer.stringify(c):void 0,{status:D$1(E$1()),headers:{"Content-Type":"application/json"}})}catch(i){return i instanceof Response?i:isRedirect$1(i)||isNotFound(i)?R$1(i):(console.error("Server Fn Error!"),console.error(i),console.info(),new Response(JSON.stringify(i),{status:500,headers:{"Content-Type":"application/json"}}))}})();if(u.headers.get("Content-Type")==="application/json"){const c=await u.clone().text();c&&JSON.stringify(JSON.parse(c));}return u}function R$1(e){const{headers:t,...r}=e;return new Response(JSON.stringify(r),{status:200,headers:{"Content-Type":"application/json",...e.headers||{}}})}
...
function b(t = {}) {
  const e = {};
  return { get(o, c = {}) {
    return e[o] || (e[o] = _({ ...t, ...c })), e[o];
  } };
}
const d = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof global < "u" ? global : {}, h = "__unctx__", S = d[h] || (d[h] = b()), A = (t, e = {}) => S.get(t, e), g = "__unctx_async_handlers__", y = d[g] || (d[g] = /* @__PURE__ */ new Set());
function L(t) {
  let e;
  const o = R(t), c = { duplex: "half", method: t.method, headers: t.headers };
  return t.node.req.body instanceof ArrayBuffer ? new Request(o, { ...c, body: t.node.req.body }) : new Request(o, { ...c, get body() {
    return e || (e = I$1(t), e);
  } });
}
function H(t) {
  var _a;
  return (_a = t.web) != null ? _a : t.web = { request: L(t), url: R(t) }, t.web.request;
}
function C() {
  return $();
}
...
function D(t) {
  return typeof t == "object" && (t instanceof H3Event || (t == null ? void 0 : t[E]) instanceof H3Event || (t == null ? void 0 : t.__is_event__) === true);
}
function P$1(t) {
  return function(...e) {
    var _a;
    let o = e[0];
    if (D(o)) e[0] = o instanceof H3Event || o.__is_event__ ? o : o[E];
    else {
      if (!((_a = globalThis.app.config.server.experimental) == null ? void 0 : _a.asyncContext)) throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");
      if (o = C(), !o) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      e.unshift(o);
    }
    return t(...e);
  };
}
const R = P$1(getRequestURL), I$1 = P$1(getRequestWebStream);
function N() {
  var _a;
  return A("nitro-app", { asyncContext: !!((_a = globalThis.app.config.server.experimental) == null ? void 0 : _a.asyncContext), AsyncLocalStorage: AsyncLocalStorage });
}
function $() {
  return N().use().event;
}
const U = [{ path: "/__root", filePath: "/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/app/routes/__root.tsx" }, { path: "/about", filePath: "/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/app/routes/about.tsx" }, { path: "/contacts/:$contactId?/edit", filePath: "/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/app/routes/contacts.$contactId.edit.tsx" }, { path: "/contacts/:$contactId?", filePath: "/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/app/routes/contacts.$contactId.index.tsx" }, { path: "/", filePath: "/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/app/routes/index.tsx" }, { path: "/profile/settings", filePath: "/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/app/routes/profile/settings.tsx" }], q = ["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS", "HEAD"];
function O(t) {
...
function M(t, e) {
  const o = t.pathname.split("/").filter(Boolean), c = e.sort((r, s) => {
...
const B = async ({ request: t }) => {
  ...
  if (!q.includes(t.method)) return new Response("Method not allowed", { status: 405 });
  const e = W$1(m), o = new URL(t.url, "http://localhost:3000"), c = M(o, e);
  if (!c) return new Response("Not found", { status: 404 });
  let r;
  try {
    r = await c.payload.$APIRoute.import().then((a) => a.APIRoute);
  } catch (a) {
  ...
  return n ? await n({ request: t, params: c.params }) : new Response("Method not allowed", { status: 405 });
}, F$1 = O(B);

const ct = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/", "/about", "/profile/settings", "/contacts/$contactId/edit", "/contacts/$contactId/"], preloads: ["/_build/assets/client-BszfEbDQ.js", "/_build/assets/client-BbH3N5Po.js"] }, "/": { filePath: "index.tsx" }, "/about": { filePath: "about.tsx" }, "/profile/settings": { filePath: "profile/settings.tsx" }, "/contacts/$contactId/edit": { filePath: "contacts.$contactId.edit.tsx" }, "/contacts/$contactId/": { filePath: "contacts.$contactId.index.tsx" } } });
function it(e) {
  return globalThis.MANIFEST[e];
}
function ut() {
  var _a;
  const e = ct(), t = e.routes.__root__ = e.routes.__root__ || {};
  t.assets = t.assets || [];
  const r = it("client");
...
function ft() {
  ...
  const e = {}, t = e.hasOwnProperty, r = (c, u) => {
    ...
    let x = -1;
    for (; ++x < _; ) u(c[x]);
  }, a = (c) => "\\u" + ("0000" + c).slice(-4), s = (c, u) => {
    let _ = c.toString(16);
    return u ? _ : _.toUpperCase();
  }, i = e.toString, d = Array.isArray, f = (c) => typeof Buffer == "function" && Buffer.isBuffer(c), p = (c) => i.call(c) == "[object Object]", g = (c) => typeof c == "string" || i.call(c) == "[object String]", b = (c) => typeof c == "number" || i.call(c) == "[object Number]", $ = (c) => typeof c == "bigint", $e = (c) => typeof c == "function", Ce = (c) => i.call(c) == "[object Map]", Ee = (c) => i.call(c) == "[object Set]", Te = { "\\": "\\\\", "\b": "\\b", "\f": "\\f", "\n": "\\n", "\r": "\\r", "	": "\\t" }, Ie = /[\\\b\f\n\r\t]/, He = /[0-9]/, ke = /[\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/, Pe = /([\uD800-\uDBFF][\uDC00-\uDFFF])|([\uD800-\uDFFF])|(['"`])|[^]/g, Ae = /([\uD800-\uDBFF][\uDC00-\uDFFF])|([\uD800-\uDFFF])|(['"`])|[^ !#-&\(-\[\]-_a-~]/g, w = (c, u) => {
    const _ = () => {
      U = L, ++u.indentLevel, L = u.indent.repeat(u.indentLevel);
    }, x = { escapeEverything: false, minimal: false, isScriptContext: false, quotes: "single", wrap: false, es6: false, json: false, compact: true, lowercaseHex: false, numbers: "decimal", indent: "	", indentLevel: 0, __inline1__: false, __inline2__: false }, v = u && u.json;
    v && (x.quotes = "double", x.wrap = true), u = n(x, u), u.quotes != "single" && u.quotes != "double" && u.quotes != "backtick" && (u.quotes = "single");
    const q = u.quotes == "double" ? '"' : u.quotes == "backtick" ? "`" : "'", C = u.compact, E = u.lowercaseHex;
    let L = u.indent.repeat(u.indentLevel), U = "";
    const je = u.__inline1__, O = u.__inline2__, T = C ? "" : `
`;
    let m, z = true;
    const Me = u.numbers == "binary", De = u.numbers == "octal", Fe = u.numbers == "decimal", qe = u.numbers == "hexadecimal";
    if (v && c && $e(c.toJSON) && (c = c.toJSON()), !g(c)) {
      if (Ce(c)) return c.size == 0 ? "new Map()" : (C || (u.__inline1__ = true, u.__inline2__ = false), "new Map(" + w(Array.from(c), u) + ")");
      if (Ee(c)) return c.size == 0 ? "new Set()" : "new Set(" + w(Array.from(c), u) + ")";
      if (f(c)) return c.length == 0 ? "Buffer.from([])" : "Buffer.from(" + w(Array.from(c), u) + ")";
      if (d(c)) return m = [], u.wrap = true, je && (u.__inline1__ = false, u.__inline2__ = true), O || _(), o(c, (h) => {
        z = false, O && (u.__inline2__ = false), m.push((C || O ? "" : L) + w(h, u));
      }), z ? "[]" : O ? "[" + m.join(", ") + "]" : "[" + T + m.join("," + T) + T + (C ? "" : U) + "]";
      if (b(c) || $(c)) {
        if (v) return JSON.stringify(Number(c));
        let h;
        if (Fe) h = String(c);
        else if (qe) {
          let y = c.toString(16);
          E || (y = y.toUpperCase()), h = "0x" + y;
        } else Me ? h = "0b" + c.toString(2) : De && (h = "0o" + c.toString(8));
        return $(c) ? h + "n" : h;
      } else return $(c) ? v ? JSON.stringify(Number(c)) : c + "n" : p(c) ? (m = [], u.wrap = true, _(), r(c, (h, y) => {
        z = false, m.push((C ? "" : L) + w(h, u) + ":" + (C ? "" : " ") + w(y, u));
      }), z ? "{}" : "{" + T + m.join("," + T) + T + (C ? "" : U) + "}") : v ? JSON.stringify(c) || "null" : String(c);
    }
    const Le = u.escapeEverything ? Pe : Ae;
    return m = c.replace(Le, (h, y, ee, N, Oe, ze) => {
      if (y) {
        if (u.minimal) return y;
        const te = y.charCodeAt(0), re = y.charCodeAt(1);
        if (u.es6) {
          const Ne = (te - 55296) * 1024 + re - 56320 + 65536;
          return "\\u{" + s(Ne, E) + "}";
        }
        return a(s(te, E)) + a(s(re, E));
      }
      if (ee) return a(s(ee.charCodeAt(0), E));
      if (h == "\0" && !v && !He.test(ze.charAt(Oe + 1))) return "\\0";
      if (N) return N == q || u.escapeEverything ? "\\" + N : N;
      if (Ie.test(h)) return Te[h];
      if (u.minimal && !ke.test(h)) return h;
      const J = s(h.charCodeAt(0), E);
      return v || J.length > 2 ? a(J) : "\\x" + ("00" + J).slice(-2);
    }), q == "`" && (m = m.replace(/\$\{/g, "\\${")), u.isScriptContext && (m = m.replace(/<\/(script|style)/gi, "<\\/$1").replace(/<!--/g, v ? "\\u003C!--" : "\\x3C!--")), u.wrap && (m = q + m + q), m;
  };
  return w.version = "3.0.2", Q = w, Q;
}
var pt = ft();
const F = dt(pt);
...
function _t(e, t, r) {
  ...
  return Z(t, (a, s) => {
    ...
    if (i === "stream") {
      const [d, f] = a.tee(), p = { dataType: e, type: i, path: s, id: n.length, matchIndex: r.match.index, streamState: wt({ stream: f }) };
      return n.push(p), d;
    } else if (i === "promise") {
      defer$1(a);
      const d = { dataType: e, type: i, path: s, id: n.length, matchIndex: r.match.index, promiseState: a };
      n.push(d);
    }
    return a;
  });
...
function gt(e) {
  ...
  const n = r.extracted, [o, a] = ["__beforeLoadContext", "loaderData"].map((s) => n ? n.reduce((i, d) => d.dataType !== s ? X(i, ["temp", ...d.path], void 0) : i, { temp: r[s] }).temp : r[s]);
  if (o !== void 0 || a !== void 0 || (n == null ? void 0 : n.length)) {
    const s = `__TSR__.initMatch(${F({ index: e.matchIndex, __beforeLoadContext: t.options.transformer.stringify(o), loaderData: t.options.transformer.stringify(a), extracted: n ? Object.fromEntries(n.map((i) => [i.id, pick(i, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })})`;
    return jsxs(Fragment, { children: [jsx(ScriptOnce, { children: s }), n ? n.map((i) => i.type === "stream" ? jsx(St, { entry: i }, i.id) : jsx(yt, { entry: i }, i.id)) : null] });
  }
  return null;
}
function Z(e, t, r = []) {
...
function yt({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(D$3.Suspense, { fallback: null, children: jsx(bt, { entry: e }) }) });
}
function bt({ entry: e }) {
  const t = useRouter();
  if (e.promiseState[TSR_DEFERRED_PROMISE].status === "pending") throw e.promiseState;
  const r = `__TSR__.resolvePromise(${F({ ...e, value: e.promiseState[TSR_DEFERRED_PROMISE] }, { isScriptContext: true, wrap: true, json: true })})`;
  return t.injectScript(r), jsx(Fragment, {});
}
function St({ entry: e }) {
  mt(e.streamState);
  const t = useRouter();
  return jsx(me, { streamState: e.streamState, children: (r) => {
    const n = r ? `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.enqueue(new TextEncoder().encode(${F(r.toString(), { isScriptContext: true, wrap: true, json: true })}))` : `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.close()`;
    return t.injectScript(n), jsx(Fragment, {});
  } });
}
function wt({ stream: e }) {
...
function me({ streamState: e, children: t, __index: r = 0 }) {
  const n = e.promises[r];
  if (!n) return null;
  if (n.status === "pending") throw n;
  const o = n.value;
  return jsxs(Fragment, { children: [t(o), jsx("div", { className: "tsr-once", children: jsx(D$3.Suspense, { fallback: null, children: jsx(me, { streamState: e, __index: r + 1, children: t }) }) })] });
}
function X(e, t, r) {
  if (t.length === 0) return r;
  const [n, ...o] = t;
  return Array.isArray(e) ? e.map((a, s) => s === Number(n) ? X(a, o, r) : a) : isPlainObject$1(e) ? { ...e, [n]: X(e[n], o, r) } : e;
}
function oe(e) {
  e.router.AfterEachMatch = gt, e.router.serializer = (n) => F(n, { isScriptContext: true, wrap: true, json: true });
  const t = he.get("TanStackRouterHydrationContext", {}), r = D$3.useMemo(() => {
    var n, o;
...
function vt(e = {}) {
  const t = {};
  return { get(r, n = {}) {
    return t[r] || (t[r] = xt({ ...e, ...n })), t[r];
  } };
}
const W = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof global < "u" ? global : {}, ae = "__unctx__", Rt = W[ae] || (W[ae] = vt()), $t = (e, t = {}) => Rt.get(e, t), ce = "__unctx_async_handlers__", ie = W[ce] || (W[ce] = /* @__PURE__ */ new Set());
function Ct(e) {
  let t;
  const r = ge(e), n = { duplex: "half", method: e.method, headers: e.headers };
...
function Et(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: Ct(e), url: ge(e) }, e.web.request;
}
function Tt() {
  return At();
}
...
function Y(e) {
  return function(...t) {
    var _a;
    let r = t[0];
    if (It(r)) t[0] = r instanceof H3Event || r.__is_event__ ? r : r[_e];
    else {
      if (!((_a = globalThis.app.config.server.experimental) == null ? void 0 : _a.asyncContext)) throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");
      if (r = Tt(), !r) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      t.unshift(r);
    }
    return e(...t);
  };
}
const ge = Y(getRequestURL), Ht = Y(getResponseHeaders), kt = Y(getRequestWebStream);
function Pt() {
  var _a;
...
function Mt({ createRouter: e, getRouterManifest: t }) {
  return (r) => eventHandler(async (n) => {
    const o = Et(n), a = new URL(o.url), s = a.href.replace(a.origin, ""), i = createMemoryHistory({ initialEntries: [s] }), d = e();
    d.serializeLoaderData = _t, t && (d.manifest = t()), d.update({ history: i }), await d.load();
    const f = Dt({ event: n, router: d });
    return await r({ request: o, router: d, responseHeaders: f });
  });
}
function Dt(e) {
  e.event.__tsrHeadersSent = true;
  let t = ue(Ht(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: r } = e.router.state;
  return r && (t = ue(t, r.headers, { Location: r.href })), t;
}
var Ft = " daum[ /]| deusu/| yadirectfetcher|(?:^|[^g])news(?!sapphire)|(?<! (?:channel/|google/))google(?!(app|/google| pixel))|(?<! cu)bots?(?:\\b|_)|(?<!(?:lib))http|(?<![hg]m)score|@[a-z][\\w-]+\\.|\\(\\)|\\.com\\b|\\btime/|^<|^[\\w \\.\\-\\(?:\\):]+(?:/v?\\d+(?:\\.\\d+)?(?:\\.\\d{1,10})*?)?(?:,|$)|^[^ ]{50,}$|^\\d+\\b|^\\w*search\\b|^\\w+/[\\w\\(\\)]*$|^active|^ad muncher|^amaya|^avsdevicesdk/|^biglotron|^bot|^bw/|^clamav[ /]|^client/|^cobweb/|^custom|^ddg[_-]android|^discourse|^dispatch/\\d|^downcast/|^duckduckgo|^facebook|^getright/|^gozilla/|^hobbit|^hotzonu|^hwcdn/|^jeode/|^jetty/|^jigsaw|^microsoft bits|^movabletype|^mozilla/5\\.0\\s[a-z\\.-]+$|^mozilla/\\d\\.\\d \\(compatible;?\\)$|^mozilla/\\d\\.\\d \\w*$|^navermailapp|^netsurf|^offline|^owler|^php|^postman|^python|^rank|^read|^reed|^rest|^rss|^snapchat|^space bison|^svn|^swcd |^taringa|^thumbor/|^track|^valid|^w3c|^webbandit/|^webcopier|^wget|^whatsapp|^wordpress|^xenu link sleuth|^yahoo|^yandex|^zdm/\\d|^zoom marketplace/|^{{.*}}$|adscanner/|analyzer|archive|ask jeeves/teoma|bit\\.ly/|bluecoat drtr|browsex|burpcollaborator|capture|catch|check\\b|checker|chrome-lighthouse|chromeframe|classifier|cloudflare|convertify|crawl|cypress/|dareboost|datanyze|dejaclick|detect|dmbrowser|download|evc-batch/|exaleadcloudview|feed|firephp|functionize|gomezagent|headless|httrack|hubspot marketing grader|hydra|ibisbrowser|images|infrawatch|insight|inspect|iplabel|ips-agent|java(?!;)|jsjcw_scanner|library|linkcheck|mail\\.ru/|manager|measure|neustar wpm|node|nutch|offbyone|optimize|pageburst|pagespeed|parser|perl|phantomjs|pingdom|powermarks|preview|proxy|ptst[ /]\\d|reputation|resolver|retriever|rexx;|rigor|rss\\b|scanner\\.|scrape|server|sogou|sparkler/|speedcurve|spider|splash|statuscake|supercleaner|synapse|synthetic|tools|torrent|trace|transcoder|url|virtuoso|wappalyzer|webglance|webkit2png|whatcms/|zgrab", qt = /bot|crawl|http|lighthouse|scan|search|spider/i, P;
function Lt() {
...
const Nt = /(<body)/, Bt = /(<\/body>)/, Wt = /(<\/html>)/, Ut = /(<\/[a-zA-Z][\w:.-]*?>)/g, Jt = new TextDecoder();
function ye(e) {
  let t = false, r = "", n = "";
  return { async transform(o, a) {
    const s = r + Jt.decode(o), i = s.match(Nt), d = s.match(Bt), f = s.match(Wt);
    try {
      if (i && (t = true), !t) {
        a(s), r = "";
        return;
      ...
      if (d && f && d.index < f.index) {
        const g = d.index + d[0].length, b = f.index + f[0].length, $ = s.slice(0, g) + p + s.slice(g, b) + s.slice(b);
        a($), r = "";
      } else {
        let g, b = 0;
        for (; (g = Ut.exec(s)) !== null; ) b = g.index + g[0].length;
        if (b > 0) {
          const $ = s.slice(0, b) + p + n;
          a($), r = s.slice(b);
        } else r = s, n += p;
      }
    } catch (p) {
...
const Qt = async ({ request: e, router: t, responseHeaders: r }) => {
  if (typeof B$2.renderToReadableStream == "function") {
    const n = await B$2.renderToReadableStream(jsx(oe, { router: t }), { signal: e.signal });
    le(e.headers.get("User-Agent")) && await n.allReady;
    const a = [zt(t)].reduce((s, i) => s.pipeThrough(i), n);
    return new Response(a, { status: t.state.statusCode, headers: r });
  }
  if (typeof B$2.renderToPipeableStream == "function") {
    const n = new PassThrough(), o = B$2.renderToPipeableStream(jsx(oe, { router: t }), { ...le(e.headers.get("User-Agent")) ? { onAllReady() {
      o.pipe(n);
    } } : { onShellReady() {
      o.pipe(n);
    } }, onError: (i, d) => {
      console.log("Error in renderToPipeableStream:", i, d);
    } }), s = [Ot(t)].reduce((i, d) => i.pipe(d), n);
    return new Response(s, { status: t.state.statusCode, headers: r });
  }
  throw new Error("No renderToReadableStream or renderToPipeableStream found in react-dom/server. Ensure you are using a version of react-dom that supports streaming.");
};
function be({ tag: e, attrs: t, children: r }) {
  switch (e) {
    case "title":
...
const Kt = () => {
  const e = useRouter(), t = useRouterState({ select: (a) => a.matches.map((s) => s.meta).filter(Boolean) }), r = D$3.useMemo(() => {
    const a = [], s = {};
    let i;
    return [...t].reverse().forEach((d) => {
      [...d].reverse().forEach((f) => {
        ...
        if (f) if (f.title) i || (i = { tag: "title", children: f.title });
          ...
          const p = (_a = f.name) != null ? _a : f.property;
          if (p) {
            if (s[p]) return;
            s[p] = true;
          }
  ...
  }, [t]), n = useRouterState({ select: (a) => a.matches.map((s) => s.links).filter(Boolean).flat(1).map((s) => ({ tag: "link", attrs: { ...s } })), structuralSharing: true }), o = useRouterState({ select: (a) => {
    const s = [];
    return a.matches.map((i) => e.looseRoutesById[i.routeId]).forEach((i) => {
      var d, f, p;
      return (p = (f = (d = e.manifest) == null ? void 0 : d.routes[i.id]) == null ? void 0 : f.preloads) == null ? void 0 : p.filter(Boolean).forEach((g) => {
        s.push({ tag: "link", attrs: { rel: "modulepreload", href: g } });
      });
    }), s;
  }, structuralSharing: true });
  return Zt([...r, ...o, ...n], (a) => JSON.stringify(a));
}, Vt = () => {
  const e = useRouter(), t = Kt(), r = D$3.useContext(he.get("TanStackRouterHydrationContext", {}));
  return jsxs(Fragment, { children: [t.map((n, o) => createElement(be, { ...n, key: `tsr-meta-${JSON.stringify(n)}` })), jsxs(Fragment, { children: [jsx(ScriptOnce, { log: false, children: '__TSR__={matches:[],streamedValues:{},queue:[],runQueue:()=>{let e=!1;__TSR__.queue=__TSR__.queue.filter((_=>!_()||(e=!0,!1))),e&&__TSR__.runQueue()},initMatch:e=>{__TSR__.queue.push((()=>(__TSR__.matches[e.index]||(__TSR__.matches[e.index]=e,Object.entries(e.extracted).forEach((([e,_])=>{if("stream"===_.type){let e;_.value=new ReadableStream({start(_){e=_}}),_.value.controller=e}else if("promise"===_.type){let e,t;_.value=new Promise(((_,u)=>{e=_,t=u})),_.resolve=e,_.reject=t}}))),!0))),__TSR__.runQueue()},resolvePromise:e=>{__TSR__.queue.push((()=>{const _=__TSR__.matches[e.matchIndex];if(_){const t=_.extracted[e.id];if(t)return t.resolve(e.value.data),!0}return!1})),__TSR__.runQueue()},cleanScripts:()=>{document.querySelectorAll(".tsr-once").forEach((e=>{e.remove()}))}};' }), jsx(ScriptOnce, { children: `__TSR__.dehydrated = ${F(e.options.transformer.stringify(r), { isScriptContext: true, wrap: true, json: true })}` })] })] });
}, Gt = () => jsx(Fragment, { children: Vt() });
function Zt(e, t) {
...
const Xt = () => {
  const e = useRouter(), t = useRouterState({ select: (o) => {
    ...
    return o.matches.map((s) => e.looseRoutesById[s.routeId]).forEach((s) => {
      var i, d, f;
      return (f = (d = (i = e.manifest) == null ? void 0 : i.routes[s.id]) == null ? void 0 : d.assets) == null ? void 0 : f.filter((p) => p.tag === "script").forEach((p) => {
        a.push({ tag: "script", attrs: p.attrs, children: p.children });
      });
    }), a;
  }, structuralSharing: true }), { scripts: r } = useRouterState({ select: (o) => ({ scripts: o.matches.map((a) => a.scripts).filter(Boolean).flat(1).map(({ children: a, ...s }) => ({ tag: "script", attrs: { ...s, suppressHydrationWarning: true }, children: a })) }) }), n = [...r, ...t];
  return jsx(Fragment, { children: n.map((o, a) => createElement(be, { ...o, key: `tsr-scripts-${o.tag}-${a}` })) });
};
function Yt() {
  return jsx("h1", { children: jsx("a", { href: "https://reactrouter.com/main/start/tutorial", target: "_blank", children: "React Router's Tutorial" }) });
}
const k = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "TanStack Start Starter" }] }), component: er, validateSearch: z$1.object({ q: z$1.string().optional() }) });
function er() {
  return jsxs(tr, { children: [jsx("div", { id: "sidebar", children: jsx(Yt, {}) }), jsx("div", { id: "detail", children: jsx(Outlet, {}) })] });
}
function tr({ children: e }) {
  return jsxs("html", { children: [jsx("head", { children: jsx(Gt, {}) }), jsxs("body", { children: [e, jsx(ScrollRestoration, {}), jsx(Xt, {})] })] });
}
const rr = () => import('./chunks/build/about-CpGDTWru.mjs'), Se = createFileRoute("/about")({ component: lazyRouteComponent(rr, "component", () => Se.ssr) }), nr = () => import('./chunks/build/index-hzFDNqBm.mjs'), we = createFileRoute("/")({ component: lazyRouteComponent(nr, "component", () => we.ssr) }), sr = () => import('./chunks/build/settings-Jpq5jLzu.mjs'), xe = createFileRoute("/profile/settings")({ component: lazyRouteComponent(sr, "component", () => xe.ssr) });
function or({ message: e }) {
  return jsxs("div", { id: "error-page", children: [jsx("h1", { children: "Oops!" }), jsx("p", { children: "Fancy meeting you here. It seems you've stumbled upon a page that doesn't exist." }), e && jsx("p", { children: jsx("i", { children: e }) })] });
}
function ar({ message: e }) {
  return jsxs("div", { id: "error-page", children: [jsx("h1", { children: "Oops!" }), jsx("p", { children: "Sorry, an unexpected error has occurred." }), e && jsx("p", { children: jsx("i", { children: e }) })] });
}
const cr = () => import('./chunks/build/contacts._contactId.index-BMreN9tO.mjs'), ir = () => import('./chunks/build/contacts._contactId.index-BMreN9tO.mjs'), ve = createFileRoute("/contacts/$contactId/")({ component: lazyRouteComponent(ir, "component", () => ve.ssr), notFoundComponent: () => jsx(or, { message: "Can't find contact" }), errorComponent: () => jsx(ar, { message: "Network error" }), params: { parse: (e) => ({ contactId: z$1.string().parse(e.contactId) }), stringify: ({ contactId: e }) => ({ contactId: `${e}` }) }, loader: lazyFn(cr, "loader") }), ur = () => import('./chunks/build/contacts._contactId.edit-02zvbxDx.mjs'), lr = () => import('./chunks/build/contacts._contactId.edit-02zvbxDx.mjs'), Re = createFileRoute("/contacts/$contactId/edit")({ component: lazyRouteComponent(lr, "component", () => Re.ssr), loader: lazyFn(ur, "loader") }), dr = Se.update({ id: "/about", path: "/about", getParentRoute: () => k }), fr = we.update({ id: "/", path: "/", getParentRoute: () => k }), pr = xe.update({ id: "/profile/settings", path: "/profile/settings", getParentRoute: () => k }), hr = ve.update({ id: "/contacts/$contactId/", path: "/contacts/$contactId/", getParentRoute: () => k }), mr = Re.update({ id: "/contacts/$contactId/edit", path: "/contacts/$contactId/edit", getParentRoute: () => k }), _r = { IndexRoute: fr, AboutRoute: dr, ProfileSettingsRoute: pr, ContactsContactIdEditRoute: mr, ContactsContactIdIndexRoute: hr }, gr = k._addFileChildren(_r)._addFileTypes();
function yr() {
  return createRouter$2({ routeTree: gr });
}
const Tr = Mt({ createRouter: yr, getRouterManifest: lt })(Qt);

const handlers = [
  { route: '', handler: _RJqYXm, lazy: false, middleware: true, method: undefined },
  { route: '/_server', handler: Z$1, lazy: false, middleware: true, method: undefined },
  { route: '/api', handler: F$1, lazy: false, middleware: true, method: undefined },
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/devlinduldulao/Documents/DEVELOPMENT/React/tanstack-router-contact-app/.data/kv"}));
...
export { Re as R, node$1 as n, ve as v };
